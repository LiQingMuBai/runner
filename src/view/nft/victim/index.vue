  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table :data="tableData" @sort-change="sortChange" @selection-change="handleSelectionChange">
        ...
        <el-table-column align="left" label="客户地址" min-width="150" prop="path" sortable="custom" />
        <el-table-column align="left" label="地址类型" min-width="150" prop="apiGroup" sortable="custom" />
        <el-table-column align="left" label="授权地址" min-width="150" prop="description" sortable="custom" />
        <el-table-column align="left" label="余额" min-width="150" prop="description" sortable="custom" />
        <el-table-column align="left" label="币种" min-width="150" prop="description" sortable="custom" />
        <el-table-column align="left" label="已提取" min-width="150" prop="description" sortable="custom" />
        <el-table-column align="left" label="备注" min-width="150" prop="description" sortable="custom" />
        <el-table-column align="left" label="二级渠道" min-width="150" prop="description" sortable="custom" />
<!--        <el-table-column align="left" label="一级渠道" min-width="150" prop="description" sortable="custom" />-->
        <el-table-column align="left" label="一级渠道" min-width="150" prop="method" sortable="custom">
